//! 示例 wasm 工具组件:`liuma:tools` world 的参考实现。
//!
//! 两个工具:
...
mod native_cabi_stubs {
    #[unsafe(export_name = "liuma:plugin/lifecycle@0.1.0")]
    extern "C" fn lifecycle_entry() {}
    #[unsafe(export_name = "liuma:tools/tools@0.1.0")]
    extern "C" fn tools_entry() {}
    #[unsafe(export_name = "cabi_post_liuma:plugin/lifecycle@0.1.0")]
    extern "C" fn lifecycle_post() {}
    #[unsafe(export_name = "cabi_post_liuma:tools/tools@0.1.0")]
