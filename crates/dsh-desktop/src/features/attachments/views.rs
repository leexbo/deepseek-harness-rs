...
fn file_kind_badge(name: &str) -> impl IntoElement {
    let kind = dsh_attachment::classify_file_name(name);
    let mark = match kind {
        dsh_attachment::FileKind::Word => "W",
        dsh_attachment::FileKind::Excel => "X",
        dsh_attachment::FileKind::Ppt => "PPT",
        dsh_attachment::FileKind::Pdf => "PDF",
        dsh_attachment::FileKind::Markdown => "MD",
        dsh_attachment::FileKind::Image => "IMG",
        dsh_attachment::FileKind::Video => "▶",
        dsh_attachment::FileKind::Html | dsh_attachment::FileKind::Code => "</>",
        dsh_attachment::FileKind::Other => "FILE",
    };
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(format!(
                            "{} {}",
                            dsh_attachment::file_extension_label(name),
    ...
    div()
        ...
        .child(
            div()
                ...
                .text_color(theme::LABEL())
                .text_size(px(14.))
                .child(fixed(DshIcon::Paperclip, 16.))
                .child("松开以添加附件"),
        )
}
